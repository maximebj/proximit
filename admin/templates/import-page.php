...
<div class="wrap">
  ...
  <div class="proximit-import-container">
    <div class="proximit-import-section">
      <h2>Import de données via API</h2>
      <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
        <?php wp_nonce_field('proximit_import_via_api_nonce', 'proximit_import_via_api_nonce'); ?>
        <input type="hidden" name="action" value="proximit_import_via_api">

        <p class="submit">
          <input type="submit" name="submit" id="submit" class="button button-primary" value="Importer via API">
        </p>

        <div class="proximit-import-results">
          Résultats…
        </div>
      </form>
    </div>
